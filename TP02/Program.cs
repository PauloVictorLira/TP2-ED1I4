...
namespace TP02
{
	class Program
	{
		static void Main(string[] args)
		{
            ...
            int qtde = 0;
            int verifica = 0;
            Participante pessoa = new Participante("fulano", "fulano@");
            Console.WriteLine("Hello World!" + pessoa.ToString());
            Evento entos = new Evento(1, "Show", 4);
            Eventos entoss = new Eventos();
            entos.inscreverParticipante(new Participante("fulano", "fulano@"));
            Console.WriteLine(entos.ToString());
            entoss.adicionarEvento(new Evento(0, "Show", 4));
            entoss.OsEventos[0].inscreverParticipante(new Participante("fulano", "fulano@"));
            Console.WriteLine(entoss.listaEventos());
            Console.WriteLine(entoss.pesquisarParticipante(new Participante("fulano", "fulano@")));
